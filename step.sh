...
zip -r "../$test_package_name" tests/features/ tests/fixtures/ tests/funtional/conftest.py tests/funtional/__init__.py tests/funtional/modulesContentCheck_test.py 
popd
